...
<body>
	<div class="container-fluid print">
		...
		<div class="content margin-top-50">
			<h4>TO WHOM IT MAY CONCERN:</h4>
				...
				<div class="content margin-top-50" style='text-indent: 50px;'>
					<h4>THIS IS TO CERTIFY that <b class="uppercase"></b>
						<h4> KHARLA JANE PASIA

						legal age and a bonafide resident of Barangay <h4> STA MESA MANILA is personally known to
						me to be a person of good moral character and law-abiding citizen in the community.</h4>
				</div>
				<div class="content margin-top-50" style='text-indent: 50px;'>
					<h4>That <h4> KHARLA JANE PASIA </b>  has not been convicted
				...
				<div class="content margin-top-50" style='text-indent: 50px;'>
					<h4>
						GIVEN this <b><span id='date'></span></b> day of <b><span id='month'></span> <span id='year'></span></b> at Barangay <h4> STA MESA MANILA Philippines.
					</h4>
				</div>
		...
		<div class=" margin-top-50">
			...
			<h4>Issued at <span  style="margin-left: 43px;"></span>: Barangay STA MESA MANILA</h4>
		</div>
